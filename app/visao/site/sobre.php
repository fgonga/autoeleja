<!doctype html>
	...
	<body>
		...
		<main role="main">
			...
			<div class="jumbotron">
				<div class="container">
					<h2 class="display-3">Sobre AutuEleja</h2>
					<p>Somos um sistema de votação online, temos como objectivo permitir ...</p>
					<p><a class="btn btn-primary btn-lg" href="#" role="button">Mais informações</a></p>
				</div>
			</div>

			<div class="container">
				<h4 class="my-0 py-0">O qué ?</h4>
				<hr>
				...
				<h4 class="my-0 py-0">Programadores</h4>
				<hr>
				<div class="row">
					<div class="col-md-3">
	...
	<script src="/publico/js/holder.min.js"></script>
</body>
</html>
