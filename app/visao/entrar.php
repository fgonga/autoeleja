...
<!doctype html>
  ...
  <head>
    ...
    <title>AutaEleja | Entrar</title>
    <link href="/publico/css/bootstrap.css" rel="stylesheet"/>
    <link href="/publico/css/entrar.css" rel="stylesheet"/>
  </head>

  <body class="text-center">
    <form class="form-signin" method="POST" action="/app/controlador/utilizador/entrar.php">
      <img class="mb-4"  alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">AutaEleja</h1>
